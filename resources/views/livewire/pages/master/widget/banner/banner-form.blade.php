          ...
          <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
              <div class="row breadcrumbs-top">
                <div class="col-12">
                  <h2 class="content-header-title float-left mb-0">Banner Form</h2>
                  <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">Widgets
                        </li>
                        <li class="breadcrumb-item active"><a href="{{ route('admin.banner') }}">Banner</a>
                        </li>
          ...
          <div class="content-body">
            ...
            <div class="blog-edit-wrapper">
                ...
                <div class="col-md-10">
                    <div class="card">
                    <div class="card-body">
                        <form class="mt-2" wire:submit.prevent="{{ isset($edit) ? 'updateBanner("'.$edit->id.'")' : 'createBanner' }}" >
                        <div class="row">
                            ...
                            <div class="border rounded p-2">
                                ...
                                <div class="media-body" >
                                    <small class="text-muted">Recommended image resolution 1920x680, image size 10mb.</small>
                                    <p class="my-50">
                            ...
                            <div class="col-12 mt-50">
                                <img src="{{ asset('icons/loading.gif') }}" wire:loading wire:target="{{ isset($edit) ? 'updateBanner("'.$edit->id.'")' : 'createBanner' }}" alt="" width="60px">
                                <button type="submit" class="btn btn-primary mr-1" wire:target="{{ isset($edit) ? 'updateBanner("'.$edit->id.'")' : 'createBanner' }}" wire:loading.attr="hidden"
                                wire:loading.attr="hidden"> Submit</button>
                                <a href="{{ route('admin.ask_expert') }}" wire:target="{{ isset($edit) ? 'updateBanner("'.$edit->id.'")' : 'createBanner' }}"  class="btn btn-danger" wire:loading.class="btn btn-secondary" wire:loading.attr="hidden">Back</a>
                            </div>
                        </div>
                        </form>
                        <!--/ Form -->
...
<script>
    $('#categories').select2().val({!! isset($category) ? $category : 1 !!}).trigger('change');
    $(document).ready(function() {
        @this.set('category',{!! isset($category) ? $category : 1 !!});
    });
