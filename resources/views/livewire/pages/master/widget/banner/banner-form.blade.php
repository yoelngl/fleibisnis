                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mt-50">
                                ...
                                <a href="{{ route('admin.banner') }}" wire:target="{{ isset($edit) ? 'updateBanner("'.$edit->id.'")' : 'createBanner' }}"  class="btn btn-danger" wire:loading.class="btn btn-secondary" wire:loading.attr="hidden">Back</a>
                            </div>
                        </div>
                        </form>
                        <!--/ Form -->
