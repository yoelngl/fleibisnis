    ...
    <div class="content-wrapper">
        <div class="content-header row">
            ...
            <div class="content-header-right text-md-right col-md-3 col-12 d-md-block ">
                ...
                <div class="dropdown">
                    <a href="{{ route('admin.banner.add') }}" class="btn-icon btn btn-primary btn-round btn-sm dropdown-toggle" >Create Banner</a>
                </div>
                </div>
            </div>
            </div>
                                  ...
                                  <table id="datatable" class="datatables-basic table ">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $item->category }}</td>
                                            <td>
                                                <a class="badge badge-sm badge-warning cursor-pointer text-light" href="{{ route('admin.banner.edit',['id' => $item->id]) }}">edit</a>
                                                <span class="badge badge-sm badge-danger cursor-pointer" wire:click.prevent="$emit('deleteBanner','{{ $item->id }}')">delete</span></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
...
<script>
    ...
    $(document).ready(function () {
          $('#datatable').DataTable();
          @this.on('deleteBanner', id => {
              Swal.fire({
                  title: 'Are You Sure?',
                  text: 'Banner will be deleted permanently!',
                  icon: "warning",
