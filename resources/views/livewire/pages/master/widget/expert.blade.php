    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                ...
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">Experts</h2>
                    <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Widgets</a>
                        </li>
                        <li class="breadcrumb-item active">Experts
                        </li>
                    </ol>
                    </div>
                </div>
            ...
            <div class="content-header-right text-md-right col-md-3 col-12 d-md-block ">
                ...
                <div class="dropdown">
                    <a href="{{ route('admin.experts.add') }}" class="btn-icon btn btn-primary btn-round btn-sm dropdown-toggle" >Create Experts</a>
                </div>
                </div>
            </div>
            </div>
                                  ...
                                  <table id="datatable" class="datatables-basic table ">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $item->name }}</td>
                                            <td><a class="badge badge-sm badge-primary cursor-pointer text-light" href="{{ route('expert.details',['slug' => $item->slug]) }}">details</a>
                                                <a class="badge badge-sm badge-warning cursor-pointer text-light" href="{{ route('admin.experts.edit',['slug' => $item->slug]) }}">edit</a>
