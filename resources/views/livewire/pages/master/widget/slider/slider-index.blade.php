    ...
    <div class="content-wrapper">
        <div class="content-header row">
            ...
            <div class="content-header-right text-md-right col-md-3 col-12 d-md-block ">
                ...
                <div class="dropdown">
                    <a href="{{ route('admin.slider.add') }}" class="btn-icon btn btn-primary btn-round btn-sm dropdown-toggle" >Create Slider</a>
                </div>
                </div>
            </div>
            </div>
                                  ...
                                  <table id="datatable" class="datatables-basic table ">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $item->title }}</td>
                                            <td>
                                                <a class="badge badge-sm badge-warning cursor-pointer text-light" href="{{ route('admin.slider.edit',['id' => $item->id]) }}">edit</a>
                                                <span class="badge badge-sm badge-danger cursor-pointer" wire:click.prevent="$emit('deleteSlider','{{ $item->id }}')">delete</span></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
...
<script>
    ...
    $(document).ready(function () {
          $('#datatable').DataTable();
          @this.on('deleteSlider', id => {
              Swal.fire({
                  title: 'Are You Sure?',
                  text: 'Slider will be deleted permanently!',
                  icon: "warning",
